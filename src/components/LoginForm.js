          ...
          <div className="bg-white shadow-lg rounded md:w-1/2 lg:w-full w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
            ...
            <div className="mt-8">
              <button
                onClick={handleLogin}
                type="button"
                className={`focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full ${loading && "py-[2px]" } `}
              >
