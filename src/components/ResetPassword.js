  ...
  return (
    <>
      <div className="container mx-auto mt-20 pb-40">
        <div style={{ maxWidth: "488px" }} className="mx-auto rounded-xl bg-white py-10 px-4 sm:px-12 ">
          ...
          <div className="w-full">
            <p className="mb-3 text-center text-2xl font-bold leading-7 text-gray-700">Reset link sent</p>
            <p className="text-center text-base leading-normal text-gray-500">We’ve sent you a password reset link. Please check your inbox and follow the instructions from there.</p>
          </div>
        </div>
      </div>
    </>
